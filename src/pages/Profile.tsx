        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="flex flex-col md:flex-row md:items-center gap-6">
              ...
              {/* Key Details Grid */}
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:bg-gray-50/50 md:p-6 md:rounded-lg md:border md:border-border dark:md:bg-white/5">
        ...
        <div className="col-span-12 md:col-span-9">
          <div className="bg-bg-card rounded-xl shadow-sm border border-border p-6 min-h-[600px]">
            ...
            {activeTab === "Contact" && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {renderField("Extension", "extension", profileData.extension)}
                  {renderField(
                    "Seating Location",
                    "seatingLocation",
            ...
            {activeTab === "Bank Details" && (
              <div className="space-y-6">
                <SectionHeader title="Financial Information" icon={Building2} />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <InputField
                    label="Account Name"
                    name="accountName"
            ...
            {activeTab === "Additional" && (
              <div className="space-y-6">
                <SectionHeader title="Additional Information" icon={BookOpen} />
